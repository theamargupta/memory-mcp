...
<html lang="en">
  <head>
    ...
    <style>
      ...
      button {
        ...
        font-weight: 700;
        cursor: pointer;
        background: linear-gradient(135deg, #4ab4d6 0%, #2f8cb6 100%);
        color: white;
      }
    </style>
  </head>
  <body>
    <form class="card" method="post">
      ...
      <p>You are signed in. Confirm access so ${escapeHtml(clientName)} can connect to your Memory MCP tools.</p>
      <div class="meta">
