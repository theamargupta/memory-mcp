...
const socials = [
  ...
  { name: 'Ko-fi', href: 'https://ko-fi.com/amargupta', icon: KofiIcon },
          ...
          <motion.div variants={staggerItem} className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 mt-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-8 py-3 rounded-xl bg-[#6366f1] text-white font-semibold text-sm hover:bg-[#818cf8] transition-all active:scale-[0.98] glow-primary"
              >
                View Full Portfolio
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-8 py-3 rounded-xl border border-[#ff5e5b]/30 text-[#ff5e5b] font-semibold text-sm hover:bg-[#ff5e5b]/10 transition-all active:scale-[0.98]"
              >
                <KofiIcon />
                Support on Ko-fi
              </a>
